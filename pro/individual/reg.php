        ...
        <div class="container-fluid">
            ...
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title"><b>Pesan Tiket Kapal Ferry</b></h3>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            while ($fetch = $row->fetch_assoc()) {
                                ...
                                <td><?php $array = getTotalBookByType($id);
                                        echo ($max_first = ($array['first'] - $array['first_booked'])), " Kursi Kelas 1" . "<hr/>" . ($max_second = ($array['second'] - $array['second_booked'])) . " Kursi Kelas Ekonomi";
                                        ?></td>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Pesan Untuk <?php echo $fullname; ?></h4>
                                            ...
                                            <form action="<?php echo $_SERVER['PHP_SELF'] . "?loc=$id" ?>"
                                                ...
                                                <p>
                                                    Class : <select name="class" required class="form-control" id="">
                                                        ...
                                                        <option value="first">First Class (Rp
                                                            <?php echo ($fetch['first_fee']); ?>)</option>
                                                        <option value="second">Economy Class (Rp
