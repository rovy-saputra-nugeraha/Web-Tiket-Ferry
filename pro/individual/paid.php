        ...
        <div class="row">
            <div class="col-12">
                <div class="callout callout-info">
                    ...
                    Riwayat Pembayaran dan Cetak Tiket
                </div>
                ...
                <div class="card">
                    <div class="card-header alert-success">
                        <h5 class="m-0">Pemesanan - Tiket yang Dibeli</h5>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Detail Untuk -<?php echo $fullname;?> 
                                                <span class="">&#128669;</span></h4>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p><b>Waktu Pembayaran:</b>
                                                    <?php echo ($row['pd']);
                                                        ?>
                                                </p>
                                                <p><b>Jumlah yang dibayarkan :</b> $
                                                    <?php echo ($row['amount']);
                                                        ?>
                                                </p>
                                                <p><b>Ref Pembayaran :</b>
                                                    <?php echo ($row['ref']);
                                                        ?>
                                                </p>
...
if (isset($_POST['modify'])){
    ...
    $query = $db->query($sql);
    if ($query){
        alert("Pembaruan Disimpan");
        load($_SERVER['PHP_SELF']."?page=paid");
        
    }else{
        alert("Terjadi Kesalahan Saat Mencoba Menyimpan.");
    }
}
