    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-success elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="images/ferry.jpg" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
        ...
        <div class="content-wrapper">
            ...
            elseif ($_GET['page'] == 'logout') {
                @session_destroy();
                echo "<script>alert('Anda sedang logout'); window.location='../';</script>";
                exit;
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong><?php echo date("Y"); ?> - Project ADBO-SK</strong>
        </footer>
    </div>
    <!-- ./wrapper -->
