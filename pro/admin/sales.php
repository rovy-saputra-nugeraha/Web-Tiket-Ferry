                            ...
                            <tbody>
                                ...
                                while ($val = $pay->fetch_assoc()) {
                                    ...
                                    echo "<tr>
                                      ...
                                      <td> Rp. ". sum($val['id'], 'first') . "</td>
                                      <td> Rp. " . sum($val['id'], 'second') . "</td>
                                      
                                      <td>" . (($array['first'] - $array['first_booked'])), ' Kursi Tersedia untuk Kelas Satu' . "<hr/>" . ($array['second'] - $array['second_booked']) . " Kursi Tersedia untuk Kelas Ekonomi" . "</td>
                                      </tr>";
                                }
                                ?>
                            </tbody>
