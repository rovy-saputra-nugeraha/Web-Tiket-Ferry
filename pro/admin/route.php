                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Edit <?php echo $fullname;
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post">
                                                        <input type="hidden" class="form-control" name="id"
                                                            value="<?php echo $id ?>" required id="">
                                                        <p>Dari : <input type="text" class="form-control"
                                                                value="<?php echo $fetch['start'] ?>" name="start"
                                                                required id="">
                                                        </p>
                                                        <p> Ke : <input type="text" class="form-control"
                                                                value="<?php echo $fetch['stop'] ?>" name="stop"
                                                                required id="">
                                                        </p>
                                                        <p>

                                                            <input class="btn btn-info" type="submit" value="Edit Rute"
                                                                name='edit'>
                                                        </p>
                                                    </form>
...
<div class="modal fade" id="add">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" align="center">
            <div class="modal-header">
                <h4 class="modal-title">Tambah Rute Baru
                </h4>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <input class="btn btn-info" type="submit" value="Add Rute" name='submit'>
                            </td>
                        </tr>
                    </table>
                </form>
...
if (isset($_POST['del_train'])) {
    ...
    if ($con->affected_rows < 1) {
        alert("Rute Tidak Dapat Dihapus. Rute Ini Telah Terikat Dengan Data Lain!");
        load($_SERVER['PHP_SELF'] . "$me");
    } else {
        alert("Rute Dihapus!");
        load($_SERVER['PHP_SELF'] . "$me");
