                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Membalas <?php echo $fullname; ?>'s
                                                       Pesan</h4>
...
if (isset($_POST['send_reply'])) {
    ...
    $id = $_POST['id'];
    if (replyTo($id, $reply)) {
        echo "<script>alert('Balasan terkirim!');window.location='admin.php'</script>";
    } else {
        echo "<script>alert('Balasan tidak dapat dikirim!');window.location='admin.php'</script>";
    }
}
